...
#set clockname {blif_clk_net}
analyze -library WORK -format verilog {/home/marupust/Desktop/research_benchmark/dc_compiler/ckt15.v}
elaborate test_final -architecture verilog -library DEFAULT
link
#uniquify
#create_clock $clockname -period 10 -waveform {0 5}
#set_clock_latency 0.1 $clockname
#set_input_delay 0.5 -clock $clockname [all_inputs]
#set_output_delay 0.5 -clock $clockname [all_outputs]
#report_port
...
write -hierarchy -format verilog -output {/home/marupust/Desktop/research_benchmark/dc_compiler/dc_ckt15.v}
